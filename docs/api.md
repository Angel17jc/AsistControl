...
| Horarios              | `GET/POST /work-shifts`, `PATCH /work-shifts/:id`, `GET/POST /work-schedules`, `GET/PATCH /work-schedules/:id`, `POST /work-schedules/assignments`, `GET /employees/:id/schedules`, `GET/POST /holidays`, `DELETE /holidays/:id` |
...
| Permisos / vacaciones | `GET/POST /leave-requests`, `POST /leave-requests/:id/review`, `POST /leave-requests/:id/cancel`                                                                                                                                 |
