...
Cada tipo de contrato define sus reglas (días por año, devengo anual o mensual, días hábiles o corridos, bono de antigüedad, caducidad de los días no usados, medios días, anticipos). El saldo **no se guarda**: se calcula en cada lectura a partir de esas reglas, la fecha de ingreso, las solicitudes aprobadas y pendientes y los ajustes manuales, con una función pura (`vacations/domain`). Una vacación se valida contra el saldo **a su fecha de inicio**, al solicitarla y otra vez al aprobarla. Los días hábiles salen del mismo calendario que la asistencia: el horario de cada persona y los feriados. Los días que caducan se gastan primero ([ADR 0009](adr/0009-vacation-expiry.md)) y una mañana puede costar medio día ([ADR 0010](adr/0010-half-day-vacations.md)). Ver [ADR 0008](adr/0008-vacation-balances.md).
