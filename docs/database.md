...
| `ContractType`                     | Reglas de vacaciones de un tipo de contrato: días por año, devengo anual o mensual, días hábiles o corridos, bono de antigüedad, caducidad de días no usados, medios días, anticipos. Datos de la empresa, no ley ([ADR 0008](adr/0008-vacation-balances.md), [0009](adr/0009-vacation-expiry.md), [0010](adr/0010-half-day-vacations.md)). |
